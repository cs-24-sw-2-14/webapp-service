...
function centerCoordinatesInRect(coordinates: CoordinateSet, rect: Rectangle) {
...
function scaleCoordinates(coordinates: CoordinateSet, scale: ScaleFactor): CoordinateSet {
	return {
